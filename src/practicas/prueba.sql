...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-01-2024 a las 11:36:39
...
ALTER TABLE `conductor_permiso`
  ADD PRIMARY KEY (`tipo_permiso`,`conductor`),
  ADD KEY `fk_conductor` (`conductor`);
...
ALTER TABLE `conductor_permiso`
  ...
  ADD CONSTRAINT `fk_tipo` FOREIGN KEY (`tipo_permiso`) REFERENCES `tipo_permiso` (`tipo`);
